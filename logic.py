...
class Logic(MovingCameraScene):
    def construct(self):
        ...
        and_lambda = MathTex(r"AND = \lambda p.\lambda q.p \ q \ F", substrings_to_isolate=["AND = ", "\lambda p.\lambda q.", "p \ ", "q", " \ F"]).scale(0.5)
        ...
        or_lambda = MathTex(r"OR = \lambda p.\lambda q.p \ T \ q", substrings_to_isolate=["OR = ", "\lambda p.\lambda q.", "p \ ", "T \ ", "q"]).scale(0.5)
        ...
        xor_lambda = MathTex(r"XOR = \lambda p.\lambda q.p \ (NOT \ q) \ q", substrings_to_isolate=["XOR = ", "\lambda p.\lambda q.", "p \ ","NOT", "q"]).scale(0.5)
